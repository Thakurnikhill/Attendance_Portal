...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    if ($stmt->execute()) {
        $msg = "<div class='success-message'>Department deleted successfully!</div>";
    } else {
        $msg = "<div class='error-message'>Error deleting department.</div>";
    }
    $stmt->close();
}
...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .departments-table { font-size: 0.97em; }
            .topbar { padding: 0 10px; }
        }
        @media (max-width: 500px) {
            .departments-table th, .departments-table td { padding: 8px 6px; }
        }
        /* Logout Modal Styles */
        .custom-modal {
            display: none;
...
<div class="container">
    ...
    <a href="add_department.php" class="add-btn">+ Add New Department</a>
        ...
        <?php foreach ($departments as $dept): ?>
            <tr>
                ...
                <td class="action-buttons">
                    <a href="edit_department.php?id=<?= $dept['dept_id'] ?>" class="btn btn-edit">Edit</a>
