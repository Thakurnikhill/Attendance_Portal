...
if (isset($_GET['delete']) && is_numeric($_GET['delete'])) {
    ...
    if ($stmt->execute()) {
        $msg = "<div class='success-message'>Session deleted successfully!</div>";
    } else {
        $msg = "<div class='error-message'>Error deleting session.</div>";
    }
    $stmt->close();
}
...
<head>
    ...
    <style>
        ...
        @media (max-width: 768px) {
            ...
            .sessions-table { font-size: 0.97em; }
            .topbar { padding: 0 10px; }
        }
        @media (max-width: 500px) {
            .sessions-table th, .sessions-table td { padding: 8px 6px; }
        }
        /* Logout Modal Styles */
        .custom-modal {
            display: none;
...
<div class="topbar">
    ...
    <nav class="nav">
        ...
        <a href="manage_sessions.php" class="active">Sessions</a>
        ...
        <?php foreach ($sessions as $session): ?>
            <tr>
                ...
                <td class="action-buttons">
                    <a href="edit_session.php?id=<?= $session['session_id'] ?>" class="btn btn-edit">Edit</a>
                    <a href="manage_sessions.php?delete=<?= $session['session_id'] ?>"
