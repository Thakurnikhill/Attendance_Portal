...
if (isset($_GET['course_id'])) {
    ...
    $stmt = $conn->prepare("SELECT u.roll_number, u.full_name
...
<head>
    <meta charset="UTF-8">
    <title>View Course Students - Faculty</title>
...
<div class="topbar">
    ...
    <nav class="nav">
        ...
        <a href="course_students.php" class="active">View Course Students</a>
